...
class AudioPreprocessor:
    ...
    def __init__(self, win_length, hop_length, placement=nemo.core.DeviceType.GPU):
        super().__init__()
...
class AudioToMelSpectrogramPreprocessor(AudioPreprocessor):
    ...
    def __init__(
        ...
        super().__init__(n_window_size, n_window_stride, placement)
...
class CropOrPadSpectrogramAugmentation:
    """
